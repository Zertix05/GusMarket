...
const FAQR=()=>{
      ...
      const faqData = [
          { question: 'Где находится рынок?', answer: 'Мы находимся в городе Минск, в ТРЦ Червенский (ул. Маяковского, 6) и ТЦ "Green" Чижовка (ул. Уборевича, 176)' },
          { question: 'В какие дни работает рынок?', answer: 'Мы работаем каждые пятница, суббота и воскресенье с 12:00 до 20:00' },
